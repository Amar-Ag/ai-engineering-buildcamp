...
class RAGResponse(BaseModel):
    ...
    checks: list[Check] = Field(description="Self-verification checklist. For each applicable rule, verify your response complies. If any check fails, fix your response before submitting."
)
